      ...
      <div name="banner" className="flex justify-center items-center mt-12">
        <div className="flex flex-col w-[30%] mr-10">
          ...
          <div className="font-large text-lg flex-wrap">
            Whatever your needs, from looking for a room mate to looking for a
            soul mate, there are hundreds of university friends that you can
            connect with.
          </div>
        </div>
            ...
            {interests.map((interest, index) => {
              return (
                <div
                  ...
                  onClick={() => handleScrollnFilterChange(interest.field)}
                >
                  <img
                    src={interest.src}
                    alt="logo"
                    width="250"
                    className="rounded-full w-64 h-64 hover:opacity-70"
                  />
                  ...
                  <span className="text-xl font-bold pt-5 font-montserrat text-slate-600">
                    {interest.field}{" "}
                  </span>
                </div>
              );
