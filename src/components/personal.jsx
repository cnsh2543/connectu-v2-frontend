...
const [addingPost, setAddingPost] = useState(false)
  ...
  const addComment = (postId) => {
    ...
    .then(response => {
      // Assuming the response includes the newly added comment
      const newComment = {...commentObj, commentid: response.data.commentId, email: response.data.email};
      setComments(prevComments => ({
        ...prevComments,
  ...
  return (
    ...
    <div className='bg-slate-50'>
      ...
      <div className='mt-10 px-24 '>
        <span className='font-bold font-montserrat text-3xl flex-wrap'>Profile Summary</span>
      </div>
      <div className='h-64 flex mt-10 mx-24 border-lg bg-white shadow-md rounded-xl items-center pl-16'>
        <div className="rounded-lg border-1 w-[33%] flex justify-center align-center"> 
            <div className='flex flex-col items-center'>
                <span className='pt-10 font-bold font-montserrat text-9xl flex-wrap'>{totalMetrics.likescount}</span>
                <span className='font-bold font-montserrat text-3xl flex-wrap'>Likes</span>
            </div>
            <img src='/thumb_up.svg' width='200'/> 
        </div>
        <div className="rounded-lg  w-[33%] flex justify-center align-center"> 
            <div className='flex flex-col items-center'>
                <span className='pt-10 font-bold font-montserrat text-9xl flex-wrap'>{totalMetrics.commentscount}</span>
                <span className='font-bold font-montserrat text-3xl flex-wrap'>Comments</span>
            </div>
            <img src='/comment.svg' width='200'/> 
         </div>
        <div className="rounded-lg w-[33%] flex justify-center align-center"> 
            <div className='flex flex-col items-center'>
                <span className='pt-10 font-bold font-montserrat text-9xl flex-wrap'>{totalMetrics.postscount}</span>
                <span className='font-bold font-montserrat text-3xl flex-wrap'>Posts</span>
            </div>
            <img src='/lists.svg' width='200'/> 
        </div>
                      ...
                      <div>
                        <div className='flex justify-between mb-2'>
                          <div className ='flex space-x-2'>
                            ...
                            <p className="font-semibold">{comment.comment_userid} <span className = 'text-gray-500'>({comment.email})</span> </p>
                          </div>
